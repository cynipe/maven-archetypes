...
import static ${package}.PersonKind.*;
...
import ${package}.everyday.EverydayGreetingModule;
import ${package}.newyear.NewYearGreatingModule;
...
public class GreetingSteps extends Steps {
    ...
    @Given("^挨拶する相手が(.+)の場合${symbol_dollar}")
